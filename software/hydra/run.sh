...
cleanup() {
	...
	sudo pkill -f "_GUI"
	# sudo pkill -f "_webDisplay" ##RD COMMENT 
	#sudo pkill -f "_webDisplay" ##RD COMMENT 
	#sudo pkill -f "_webDisplay" ##RD COMMENT
...
#echo "Python Server running at $IPADDR:8080" ##RD COMMENT
#echo "PHP Server running at $IPADDR:$IPPORT" ##RD COMMENT
#sudo php -S $IPADDR:$IPPORT -t _webDisplay >&- 2>&- ##RD COMMENT
