...
''' Rebecca's Notes: This script sets up the ReceiveRTLSDR Class and it's associated methods
which get used in the hydra_signal_processor.py and hydra_main_window.py files. Nothing in this
script should be changed in PSU-Beam-Team implementation of this software.'''
...
class ReceiverRTLSDR():
    ...
    # *************************************************************************************
    #                   SHOULDN'T NEED TO CHANGE ANYTHING IN __init__
    ''' This initialization method is just setting the parameters in the setup and configuration
        window when you first open the demo software'''
    # *************************************************************************************
    def __init__(self):
    ...
    # *************************************************************************************
    #                   NEED TO KEEP set_sample_offsets ()
    ''' This is getting used in hydra_signal_processor.py,and it is used for synchronization purposes'''
    # *************************************************************************************         
    ...
    # *************************************************************************************
    #                   NEED TO KEEP reconfigure_tiner ()
    '''Everytime the frequency, sample rate, and gains are set, synchronization needs to 
    be set again '''
    # *************************************************************************************   
    ...
    # *************************************************************************************
    #                   NEED TO KEEP THE REST
    '''The rest of this code is used in setting the main screen: "Configuration and Spectrum" 
